...
import { getImageUrl, IMAGE_SIZES } from "@/utils/tmdb";
...
class Media {
  ...
  createShader() {
    ...
    img.onerror = () => {
      ...
      fallbackImg.src = `https://picsum.photos/seed/${this.index}/800/600`;
      fallbackImg.onload = () => {
  ...
  const items = useMemo(() => {
    ...
    return movies.map((movie) => ({
      image:
        ...
        ) || `https://picsum.photos/seed/${movie.id}/800/600`,
      text: "title" in movie ? movie.title : movie.name,
    }));
  }, [movies]);
