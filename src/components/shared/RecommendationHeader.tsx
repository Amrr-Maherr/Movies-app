        ...
        <div className="flex flex-col items-center md:items-start md:flex-row gap-4 sm:gap-6 md:gap-8 lg:gap-10">
          ...
          <div className="flex-1 text-center md:text-left pt-2 sm:pt-4 md:pt-6">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 justify-center md:justify-start">
              ...
              <div className="group flex items-center gap-2 sm:gap-2.5 bg-gradient-to-br from-red-600/20 to-red-600/10 backdrop-blur-sm px-3 sm:px-5 py-2 sm:py-3 rounded-lg sm:rounded-xl border border-red-600/30 hover:border-red-500/50 transition-all duration-300 hover:scale-105">
