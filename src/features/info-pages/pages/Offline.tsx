  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--background-primary)] text-[var(--text-primary)] p-4">
      <HelmetMeta
        ...
        description={t('common.offlineMessage')}
      />
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold mb-2">{t('common.offline')}</h1>
        ...
        <div className="mt-12 text-left bg-white/5 rounded-lg p-4">
          <h3 className="font-semibold mb-2">{t('infoPages.offline.tips')}</h3>
          <ul className="text-sm text-gray-400 space-y-1">
            <li>• {t('common.offlineTips')}</li>
            <li>• {t('common.offlineRefresh')}</li>
            <li>• {t('common.offlineCache')}</li>
          </ul>
        </div>
      </div>
    </div>
