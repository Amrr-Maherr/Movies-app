    ...
    <div className="w-full max-w-[600px] mx-auto px-6 py-16 bg-black text-white text-center">
      ...
      <div className="mb-10">
        <div className="relative inline-block">
          <CheckCircle2 className="w-24 h-24 text-[var(--netflix-red)] mx-auto" />
          <div className="absolute inset-0 bg-[var(--netflix-red)] blur-3xl opacity-20 -z-10" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-left">
        <div className="p-4 bg-neutral-900/50 rounded-xl border border-neutral-800 flex flex-col items-center text-center">
          <Play className="w-8 h-8 text-[var(--netflix-red)] mb-3" />
          <p className="text-sm font-medium">Unlimited Streaming</p>
        </div>
        <div className="p-4 bg-neutral-900/50 rounded-xl border border-neutral-800 flex flex-col items-center text-center">
          <LayoutGrid className="w-8 h-8 text-[var(--netflix-red)] mb-3" />
          <p className="text-sm font-medium">Multi-Device Access</p>
        </div>
        <div className="p-4 bg-neutral-900/50 rounded-xl border border-neutral-800 flex flex-col items-center text-center">
          <User className="w-8 h-8 text-[var(--netflix-red)] mb-3" />
      ...
      <div className="space-y-4">
        <Button
          onClick={onGoHome}
          className="w-full bg-[var(--netflix-red)] hover:bg-[var(--netflix-red-hover)] text-white h-16 text-xl font-bold rounded-md shadow-lg transition-all active:scale-[0.98] flex items-center justify-center gap-3"
        >
