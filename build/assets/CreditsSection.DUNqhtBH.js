...
import { r as t } from "./react-vendor.CdCUh6yn.js";
import { S as i } from "./slider.BDpQsuDG.js";
import { Card as a } from "./index.BmFO-ehj.js";
...
const r = t.memo(function ({ cast: r, crew: l }) {
  const [s, o] = t.useState("all"),
    n = t.useMemo(() => {
      let e = r;
      return (
        "movies" === s
          ? (e = r.filter((e) => "movie" === e.media_type))
          : "tv" === s && (e = r.filter((e) => "tv" === e.media_type)),
        [...e].sort((e, t) =>
    ...
    d = t.useMemo(() => {
      ...
      return (
        "movies" === s
          ? (e = l.filter((e) => "movie" === e.media_type))
          : "tv" === s && (e = l.filter((e) => "tv" === e.media_type)),
        [...e].sort((e, t) => t.popularity - e.popularity).slice(0, 20)
      );
    }, [l, s]),
    m = n.length > 0,
    c = d.length > 0,
