...
import { S as s } from "./slider.BDpQsuDG.js";
import { Card as t } from "./index.BmFO-ehj.js";
import { T as r } from "./TrailerModal.Dl2L-lha.js";
...
const o = i.memo(function ({ videos: o }) {
  ...
  return 0 === p.length
    ...
    : e.jsxs(e.Fragment, {
        children: [
          ...
          a &&
            e.jsx(r, { videoKey: a.key, title: a.name, isOpen: n, onClose: j }),
        ],
      });
});
export { o as default };
