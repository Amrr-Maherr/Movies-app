import { j as s } from "./animation-vendor.v8GfB2uW.js";
import { r as o } from "./react-vendor.CdCUh6yn.js";
import { Card as e } from "./index.BmFO-ehj.js";
...
const r = o.memo(function ({ seasons: r, tvShowId: t }) {
  const i = o.useMemo(
    () =>
      r
        .filter((s) => s.season_number > 0)
        .sort((s, o) => s.season_number - o.season_number),
    [r],
  );
  return i && 0 !== i.length
    ? s.jsx("section", {
        ...
        children: s.jsxs("div", {
          className: "container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl pt-8",
          children: [
            s.jsx("h3", {
            ...
            s.jsx("div", {
              ...
              children: i.map((o) =>
                s.jsx(e, { variant: "season", season: o, tvShowId: t }, o.id),
              ),
            }),
          ],
        }),
