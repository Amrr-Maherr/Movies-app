...
import { Card as i } from "./index.BmFO-ehj.js";
import { S as r } from "./slider.BDpQsuDG.js";
import { ae as o } from "./page-details.flLJVcKW.js";
...
const t = s.memo(function ({ cast: t, crew: a }) {
  const n = s.useMemo(() => t.slice(0, 20), [t]),
    l = s.useMemo(() => o(a), [a]);
                      ...
                      e.jsx(
                        i,
                        {
                          ...
                          person: {
                            id: s.id,
                            name: s.name,
                            profileImage: s.profile_path,
                            role: s.character || "Unknown role",
                          },
                        },
                        s.id,
                      ),
